...
class CrudBackpackCommand extends Command
{
    ...
    protected $base_signature = 'project';
    /**
     * The name and signature of the console command.
     *
     * @var string
     */
    protected $signature = 'project:crud {name}';
    ...
    protected $target_namespace = 'Domain\\';
    ...
    public function handle()
    {
        ...
        $this->call($this->base_signature.':crud-controller', ['name' => $name]);

        // Create the CRUD Model and show output
        $this->call($this->base_signature.':crud-model', ['name' => $name]);
