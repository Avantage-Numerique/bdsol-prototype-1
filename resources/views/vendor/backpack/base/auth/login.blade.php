    ...
    <div class="row justify-content-center">
        <div class="col-12 col-md-8 col-lg-4">
            ...
            <div class="text-center">
                <img src="{{asset('images/avantage-numerique-noire-nopadding.svg')}}" alt="{{config('app.name')}}" class="w-75" />
                <h3 class="text-center mb-4 mt-4">{{ trans('backpack::base.login') }} - {{config('app.name')}}</h3>
            </div>
            <div class="card">
